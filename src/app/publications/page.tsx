...
export default async function Publication() {
  const dataPublication = await getPublication();
  if (!dataPublication || dataPublication.length === 0) {
    return <SkeletonTemplatePages />;
  }

  const publications = dataPublication.find(
    (page) => page.slug === "publications"
  );
  ...
  */
  ...
  return (
    <div>
      <HeaderPageSection title={publications.title} />
          ...
          <div className="row align-items-center">
            <div className="col-md-12">
              <div className="main-page">
                ...
                <div
                  className="publications-description"
                  style={{ fontSize: 14, lineHeight: 1.8, color: "#555" }}
                  dangerouslySetInnerHTML={{
                    __html: publications.description,
